...
O **Auto Scaling Group (ASG)** é o serviço responsável por garantir que a aplicação mantenha a quantidade adequada de instâncias EC2 em execução, proporcionando **alta disponibilidade**, **recuperação automática de falhas** e **escalabilidade horizontal** conforme a demanda de utilização da infraestrutura.
...
## Percentual de Instâncias Saudáveis
...
# Fluxo Completo do Auto Scaling Group
