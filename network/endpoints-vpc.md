...
## Interface Endpoint — Systems Manager (SSM)
...
Permite que as instâncias EC2 sejam gerenciadas pelo AWS Systems Manager, possibilitando:

* Execução de comandos remotos (Run Command)
* Gerenciamento sem utilização de SSH
* Atualizações e manutenção das instâncias
...
Responsável pelo canal de comunicação entre o agente do Systems Manager instalado na instância e o serviço AWS Systems Manager.

Este endpoint é obrigatório para o funcionamento do SSM.
...
## Interface Endpoint — Amazon ECR API
...
## Interface Endpoint — Amazon ECR Docker
