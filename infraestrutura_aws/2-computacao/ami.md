...
A **Amazon Machine Image (AMI)** é responsável por fornecer a imagem base utilizada para criação automática das instâncias EC2 pertencentes ao Auto Scaling Group nas duas propostas de arquitetura deste projeto.
...
A criação da AMI ocorre a partir de uma instância EC2 sob demanda.
...
### 3. Instalação do AWS Systems Manager Agent
...
### 1. Utilização na Proposta Low-Cost
...
### 2. Utilização na Proposta de Maior Investimento
