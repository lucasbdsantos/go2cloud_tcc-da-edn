...
* Centralizar o gerenciamento de permissões através de grupos IAM.
* Segregar responsabilidades entre os diferentes perfis da equipe.
* Reduzir riscos de alterações indevidas na infraestrutura.
* Facilitar a administração e expansão da equipe.
* Garantir rastreabilidade das ações realizadas pelos usuários.
